...
def save_trainLosses2mat_SpaceTime(loss_it, loss_bd, loss_init, loss, name2in=None, name2bd=None, name2init=None, name2all=None,
                                   actName=None, outPath=None):
    outFile2data = '%s/Loss2%s.mat' % (outPath, actName)
    key2mat_1 = str.lower(name2in)
    key2mat_2 = str.lower(name2bd)
    key2mat_3 = str.lower(name2init)
    key2mat_4 = str.lower(name2all)
    scio.savemat(outFile2data, {key2mat_1: loss_it, key2mat_2: loss_bd, key2mat_3: loss_init, key2mat_4: loss})
